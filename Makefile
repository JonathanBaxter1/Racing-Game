...
ifeq ($(PLATFORM), linux)
	...
	COMPILE_FLAGS += $(shell pkg-config --cflags freetype2)
	CXX := g++
	EXE := bin/race
endif
ifeq ($(PLATFORM), windows)
	...
	COMPILE_FLAGS += -Iassimp/build-windows/include -Iglew-2.2.0/include -Iglfw-3.4/include -I/opt/freetype-windows/include/freetype2
